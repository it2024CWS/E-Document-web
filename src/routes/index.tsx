...
import { HOME_PATH, LOGIN_PATH, USER_PATH, DOCUMENT_PATH, INCOMING_PATH, OUTGOING_PATH, DEPARTMENT_PATH, DOCTYPE_PATH, DASHBOARD_PATH, ROLE_PATH, DOC_CENTER_PATH, REJECTED_DOC_PATH } from './config';
...
import RejectedDocumentPage from '@/pages/rejected-document';
